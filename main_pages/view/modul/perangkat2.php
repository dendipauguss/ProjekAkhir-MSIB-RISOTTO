<div class="container-fluid bg-gradient-light">
    ...
    <script type="text/javascript">
      setInterval(() => {
        $.getJSON("https://blynk.cloud/external/api/get?token=khDFH2NnozzBW0HoFYsjGRit5bkQWv3P&v0&v1&v2", function(hasil) {
          console.log(hasil);
          let rataSuhu = parseFloat(hasil.v1);
          let rataHum = parseFloat(hasil.v2);
          let rataCO2 = parseFloat(hasil.v0);
        ...
        $.getJSON("https://blynk.cloud/external/api/isHardwareConnected?token=khDFH2NnozzBW0HoFYsjGRit5bkQWv3P", function(hasil) {
          console.log(hasil);
          if (hasil == false) {
